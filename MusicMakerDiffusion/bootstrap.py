...
GTZAN: 30s clips, 10 genres, research-standard, freely available. This is a
bootstrap so the diffusion pipeline can be proven today -- for a real run, copy
the SAME tracks here that the AR project trains on, or the comparison is not
apples-to-apples.
...
import audio_io
from dconfig import DCFG as CFG, DATA_RAW
